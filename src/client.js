...
`
    ...
    const DICT = {
      zh: {
        ...
        "scenes.title": "场景", "scenes.desc": "管理场景：启用后它的记忆自动进系统提示词；带 MCP/技能段的场景还能一键切入、退出「当前模式」。",
...
"memory.stat.total": "条记忆", "memory.stat.scenes": "个启用场景", "memory.stat.sceneCount": "个场景", "memory.status.sceneOff": "场景未启用", "memory.status.off": "本条已停用",
        ...
        "memory.field.group": "场景", "memory.field.group.placeholder": "例如 办公 / 日常 / code-review；留空 = 全局", "memory.field.group.hint": "记忆存在 ~/.dsh/tool-management/memories/<场景>/ 下；场景要先在「场景」页创建（留空 = 保留场景「全局」，任何对话都注入）",
      ...
      en: {
        ...
        "scenes.title": "Scenes", "scenes.desc": "Manage scenes: enabling one injects its memories into the system prompt, and a scene with MCP/skill sections can be entered as, or left as, the active mode in one click.",
...
"memory.stat.total": "memories", "memory.stat.scenes": "enabled scenes", "memory.stat.sceneCount": "scenes", "memory.status.sceneOff": "scene off", "memory.status.off": "this memory is off",
        ...
        "memory.field.group": "Scene", "memory.field.group.placeholder": "e.g. office / daily / code-review; blank = global", "memory.field.group.hint": "Memories live under ~/.dsh/tool-management/memories/<scene>/; the scene must exist first (create it on the Scenes page). Blank = the reserved scene “global”, injected into every conversation",
