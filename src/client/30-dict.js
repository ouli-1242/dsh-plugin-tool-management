    const DICT = {
      zh: {
        ...
        "compat.fallback.native": "改走原生入口", "compat.fallback.refuse": "该操作会被拒绝", "compat.fallback.blocked": "相关按钮已禁用",
        ...
        "compat.token": "访问令牌", "compat.token.hint": "解锁本次启动，或管理令牌保护",
        "compat.token.host": "宿主配置", "compat.token.row.run": "本次启动", "compat.token.row.protect": "保护开关",
        ...
        "compat.token.loginHint": "只对本次启动有效：DSH 重启后要重新解锁。",
        "compat.token.loginHint.inactive": "令牌没在生效：填了不解锁写操作，但能用来开启保护。",
        "compat.token.inactive": "已记到本机，但令牌没在生效（已关闭或待重启）—— 重启后再看是否匹配。",
        "compat.token.hostHint": "写进配置文件，重启 DSH 后生效。",
        "compat.token.editHint": "改令牌与删除都要再输一次当前令牌。",
        "compat.token.edit.formHint": "当前令牌对上才会写入；重启 DSH 后生效。",
        "compat.token.wrong": "令牌不对：请填入配置里的当前令牌。",
        "compat.token.unlockedHint": "只保存在本机浏览器。",
        "compat.token.offHint": "关闭要再输一次当前令牌；之后写操作不再要令牌。",
        ...
        "compat.token.clearHost": "删除令牌", "compat.token.clearConfirm.yes": "确认删除",
        "compat.token.clearConfirm.hint": "再输一次当前令牌；删除后配置里不再有令牌。",
        "compat.token.proofNeed": "请先填入当前令牌。",
        "compat.token.placeholder": "令牌内容",
        "compat.token.save": "解锁", "compat.token.clear": "清除", "compat.token.unlocked": "已解锁",
        "compat.token.setHost": "设置令牌", "compat.token.edit": "修改令牌", "compat.token.offHost": "关闭保护", "compat.token.onHost": "开启保护",
        "compat.token.hostSet": "已写入配置，重启 DSH 后生效。", "compat.token.hostOn": "已重新开启，重启 DSH 后生效。",
        "compat.token.hostOff": "已关闭，重启 DSH 后生效（令牌仍留在配置里）。",
        "compat.token.hostClear": "已从配置里删除，重启 DSH 后生效。旧备份里仍有明文副本。",
        "compat.token.hostNoChange": "配置没有需要改动的地方。",
        ...
        "compat.token.needCurrent": "要开启保护，请先在「本次启动」里填入当前令牌并解锁。",
        "compat.token.empty": "请先填入令牌",
        "compat.token.saved": "已填写，宿主认可这串令牌；请重试刚才的操作。",
        "compat.token.noHost": "已记录，但宿主还没配置令牌：请点「设置令牌」写入配置。",
        "compat.token.mismatch": "与宿主配置的令牌不一致：请填入配置里的那个值。",
        "compat.token.cleared": "已清空本次填写的令牌。",
...
"memory.stat.total": "条记忆", "memory.stat.scenes": "个启用场景", "memory.stat.sceneCount": "个场景", "memory.status.sceneOff": "场景未启用", "memory.status.off": "本条已停用",
      ...
      en: {
        ...
        "compat.fallback.native": "Falls back to native entry", "compat.fallback.refuse": "Operation refused", "compat.fallback.blocked": "Affected buttons disabled",
        ...
        "compat.token": "Access token", "compat.token.hint": "Unlock this run, or manage token protection",
        "compat.token.host": "Host config", "compat.token.row.run": "This run", "compat.token.row.protect": "Protection switch",
        ...
        "compat.token.loginHint": "Valid for this run only: unlock again after DSH restarts.",
        "compat.token.loginHint.inactive": "The token is not in effect: it will not unlock writes, but you can use it to turn protection back on.",
        "compat.token.inactive": "Saved in this browser, but the token is not in effect right now (off, or waiting for a restart) — after the restart, check whether it matches.",
        "compat.token.hostHint": "Written to the config file; takes effect after a DSH restart.",
        "compat.token.editHint": "Changing or deleting the token asks for the current token again.",
        ...
        "compat.token.unlockedHint": "Kept in this browser only.",
        "compat.token.offHint": "Turning it off asks for the current token once more; afterwards writes need no token.",
        ...
        "compat.token.clearHost": "Delete token", "compat.token.clearConfirm.yes": "Delete it",
        ...
        "compat.token.save": "Unlock", "compat.token.clear": "Clear", "compat.token.unlocked": "Unlocked",
        "compat.token.setHost": "Set token", "compat.token.edit": "Change token", "compat.token.offHost": "Turn protection off", "compat.token.onHost": "Turn protection on",
        "compat.token.hostSet": "Written to the config; takes effect after a DSH restart.", "compat.token.hostOn": "Switched back on; takes effect after a DSH restart.",
        "compat.token.hostOff": "Turned off; takes effect after a DSH restart (the token stays in the config).",
        "compat.token.hostClear": "Deleted from the config; takes effect after a DSH restart. Old backups still hold plaintext copies.",
        "compat.token.hostNoChange": "The config needs no change.",
        ...
        "compat.token.needCurrent": "To turn protection on, fill the current token into the This run row above and unlock.",
        "compat.token.empty": "Enter a token first",
        "compat.token.saved": "Saved, and the host accepts this token; retry the operation that failed.",
        ...
        "compat.token.cleared": "Cleared this run's token.",
