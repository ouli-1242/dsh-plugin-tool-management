    const DICT = {
      zh: {
        ...
        "compat.tools.about.skill_manager_create": "新建一个技能",
        ...
        "compat.tools.hover.skill_manager_create": "在指定来源目录下新建技能（名字、描述、SKILL.md 正文）。技能目录会进每一轮上下文，描述写清「什么时候用它」，模型才找得到。",
...
"memory.stat.total": "条记忆", "memory.stat.scenes": "个启用场景", "memory.stat.sceneCount": "个场景", "memory.status.sceneOff": "场景未启用", "memory.status.off": "本条已停用",
      ...
      en: {
        ...
        "compat.tools.about.skill_manager_create": "Create a skill",
        ...
        "compat.tools.hover.skill_manager_create": "Creates a skill in the given source (name, description, SKILL.md body). The catalog is injected into every request, so make the description say when to use it — that is how the model finds it.",
