    const DICT = {
      zh: {
        ...
        "compat.tools.about.subagent_manager_run": "按人设跑一个子智能体",
        "compat.tools.about.subagent_manager_set_enabled": "启用或停用人设",
        "compat.tools.about.subagent_manager_create": "新建一个人设",
        "compat.tools.about.subagent_manager_update": "改人设（含改名）",
        ...
        "compat.tools.hover.subagent_manager_create": "新建人设：名字、描述、正文（会作为子代理的系统提示词），可带 provider、模型与工具限制。描述决定模型什么时候会选它。",
        "compat.tools.hover.subagent_manager_update": "改一个人设：正文、描述、provider、模型、工具限制，或改名（场景与档案里的绑定会跟着改）。没传的字段保持原样。",
...
"memory.stat.total": "条记忆", "memory.stat.scenes": "个启用场景", "memory.stat.sceneCount": "个场景", "memory.status.sceneOff": "场景未启用", "memory.status.off": "本条已停用",
      ...
      en: {
        ...
        "compat.tools.about.subagent_manager_create": "Create a persona",
        "compat.tools.about.subagent_manager_update": "Update a persona (can rename)",
        ...
        "compat.tools.hover.subagent_manager_create": "Creates a persona: name, description and body (the body becomes the subagent's system prompt), plus optional provider, model and tool limits. The description decides when the model picks it.",
        "compat.tools.hover.subagent_manager_update": "Updates a persona: body, description, provider, model, tool limits, or a rename (scene and archive bindings follow the rename). Omitted fields are kept as they are.",
