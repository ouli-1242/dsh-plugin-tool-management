...
//
//   e.options.id !== 'dsh-plugin-tool-management'      // skip our own row
...
const self = () => ({ options: { id: 'dsh-plugin-tool-management', name: 'dsh-plugin-tool-management' }, get disabled() { return REENTRANT() } })
const legacyRow = (enabled) => ({ options: { id: 'mcp-manager', name: 'dsh-plugin-tool-management' }, disabled: !enabled })
